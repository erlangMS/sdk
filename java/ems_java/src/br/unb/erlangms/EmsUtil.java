...
public final class EmsUtil {
    ...
    public static String toJson(final Object obj) {
        return RestUtils.toJson(obj, false);
    }
    ...
    public static String toJson(final Object obj, boolean serializeFullObject) {
        return RestUtils.toJson(obj, serializeFullObject);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T fromJson(final String jsonString, final Class<T> classOfObj, final EmsJsonModelAdapter jsonModelAdapter) throws Exception {
        return RestUtils.fromJson(jsonString, classOfObj, jsonModelAdapter);
    }
    ...
    public static <T> List<T> fromListJson(final String jsonString, final Class<T> classOfObj, final EmsJsonModelAdapter jsonModelAdapter) {
        return RestUtils.fromListJson(jsonString, classOfObj, jsonModelAdapter);
    }
    ...
    public static void setQueryParameterFromMap(final Query query, final Map<String, Object> values) {
        RestUtils.setQueryParameterFromMap(query, values);
    }
    ...
    public static Object setValuesFromMap(final Object obj, final Map<String, Object> values, final EmsJsonModelAdapter jsonModelAdapter) throws Exception {
        return RestUtils.setValuesFromMap(obj, values, jsonModelAdapter);
    }
    ...
    /**
     * Converte um objeto Java para um oobjeto de response. Isso é utilizado
     * para enviar a resposta para o barramento no formato nativo Erlang.
     *
     * @param ret objeto
    ...
    public static Object mergeObjects(final Object obj1, final Object obj2, final EmsJsonModelAdapter jsonModelAdapter) throws Exception {
        Map<String, Object> values = ObjectFieldsToMap(obj2);
        return RestUtils.setValuesFromMap(obj1, values, jsonModelAdapter);
    }
    ...
    /**
     * Gera um relatório no formato pdf a partir de um template jasper. É
     * importante o contrato do serviço declarar "content_type" :
     ...
     * obrigatório. Ex.: "/relatorios/DeclaracaoAlunoRegular.jasper"
     * @param owner referência para objeto quem invoca esse metodo. Utilizado
     * para owner.getClass().getResourceAsStream()
     * @return byte[] retorna um fluxo de bytes que deve ser tratado pelo
     * frontend para geração do pdf
     ...
     *
     * O processo ems_ldap_server precisa estar habilitado no barramento, caso
     * ele seja o servidor LDAP.
     *
     ...
     * configuration/standalone/standalone.conf. As properties podem ser
     * incluídas também na IDE Eclipse Open Launch Configuration/VM Arguments
     *
     *
     * Definições de propriedade no JBoss/Widfly: -Dcookie=erlangms
     * -Dems_node=node01 -Dems_emsbus=http://localhost:2301
     * -Dems_cookie=erlangms -Dems_max_thread_pool_by_agent=100
     * -Dems_user=xxxxxxx -Dems_ldap_admin_passwd="xxxxxxx"
     * -Dems_ldap_admin="cn=admin,dc=unb,dc=br"
     ...
     * -Dems_emsbus=ems_bus -Dems_cookie=erlangms
     * -Dems_max_thread_pool_by_agent=100 -Dems_debug=false -Dems_user=xxxxxxx
     * -Dems_ldap_admin_passwd="xxxxxx" -Dems_ldap_admin="cn=admin,dc=unb,dc=br"
     * -Dems_ldap_url="ldap://localhost:2389" -Dems_smtp_passwd="xxxxxxxx"
     * -Dems_smtp_from="erlangms@unb.br" -Dems_smtp_port=587
     * -Dems_smtp="mail.unb.br"
     *
     ...
     *
     * Exemplo sem anexo: EmsUtil.sendTextMail("evertonagilar@gmail.com", "isso
     * é um teste", "conteúdo do email", null);
     *
     * Exemplo com anexo: String[] anexos = new String[1]; anexos[0] =
     * "/home/everton/desenvolvimento/erlangms/ems-bus/build.sh";
     * EmsUtil.sendTextMail("evertonagilar@gmail.com", "isso é um teste",
     * "conteúdo do email", anexos);
     *
     *
     ...
     * (private porque ainda não funciona) Ex.:
     * EmsUtil.sendHtmlMail("evertonagilar@gmail.com", "isso é um teste",
     * "<h1>contedo do email<h1>", null);
     *
     * As seguintes informações são lidas das properties. Verifique
     * EmsUtil.properties: -Dems_smtp_passwd="xxxxxxxx"
     * -Dems_smtp_from="erlangms@unb.br" -Dems_smtp_port=587
...
//                    }
     ...
     * exception EmsValidationException.
     *
    ...
    /**
     * Permite passar args que recebido em main para o SDK É utilizado para
     * buscar parâmetros com getProperty
     *
    ...
    /**
     * Adiciona um hook na JVM para monitorar e manter o arquivo de pid do
     * processo baseado no algorítmo criado para o SisRuCatracas
     *
     * @param fileNamePid nome do arquivo de pid
    ...
    /**
     * Adiciona um hook na JVM para monitorar o arquivo de pid do processo Se
     * ficar desatualizado por muito tempo, o processo será encerrado
     * normalmente
     *
