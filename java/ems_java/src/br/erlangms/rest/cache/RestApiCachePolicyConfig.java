...
public class RestApiCachePolicyConfig implements IRestApiCachePolicyConfig {
    ...
    public final static int DEFAULT_ENTRY_SIZE_BYTES = 16000; // 16 KB
    ...
    public void setAllowResultCache(boolean allowResultResult) {
        if (!allowRequestCache){
            throw new RestApiConstraintException(RestApiConstraintException.RESULT_CACHE_PERMITIDO_SE_REQUEST_CACHE_ATIVO);
        }
