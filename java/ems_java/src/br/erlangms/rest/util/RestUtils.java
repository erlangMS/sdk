...
public final class RestUtils {
    ...
    private static final NumberFormat doubleFormatter = NumberFormat.getInstance(Locale.US);
        ...
        gson = new GsonBuilder()
                ...
                .registerTypeAdapter(BigDecimal.class, new JsonSerializer<BigDecimal>() {
                    ...
                    public JsonElement serialize(BigDecimal value, Type arg1, com.google.gson.JsonSerializationContext arg2) {
                        String result;
                        result = RestUtils.doubleFormatter.format(value);
     ...
     * @throws java.lang.Exception erro se não conseguir mapear
     * @author Everton de Vargas Agilar
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
            ...
            for (String field_name : values.keySet()) {
                try {
                    ...
                    if (tipo_field == Integer.class || tipo_field == int.class) {
                        ...
                        final String m_erro = field_name + " não � uma data válida.";
                        if (new_value instanceof String) {
                        ...
                        try {
                            ...
                            throw new RestApiException(field_name + " não � v�lido.");
                        }
                        ...
                        try {
                            ...
                            throw new RestApiException(field_name + " inv�lido.");
                        }
                    } else {
                        throw new RestApiException("N�o suporta o tipo de dado do campo " + field_name + ".");
                    }
                } catch (IllegalAccessException | RestApiException | InstantiationException e) {
                    throw new RestApiException("Campo " + field_name + " inv�lido. Motivo: " + e.getMessage());
                }
            }
        }
        return obj;
     ...
     * @param ann	  anotação que serão pesquisada. Ex.: Id.class
     ...
     *
     * @param obj Objeto que serão serializado para json
     ...
     * @param <T>        String json
     * @param classOfObj	Classe do objeto que serão serializado
     * @return objeto
     * @throws java.lang.Exception erro se não conseguir serializar
     * @author Everton de Vargas Agilar
     */
    ...
    /**
     * Serializa um objeto a partir de uma string json.
     * Quando a string json � vazio, apenas inst�ncia um objeto da classe.
     *
     * @param jsonString       String json
     * @param <T>              String json
     * @param classOfObj	      Classe do objeto que serão serializado
    ...
    public static <T> T fromJson(String jsonString, final Class<T> classOfObj, final JsonModelAdapter jsonModelAdapter) throws Exception {
        if (classOfObj != null) {
            try {
                if (jsonString != null && !jsonString.isEmpty()) {
                    ...
                    if (classOfObj == List.class || classOfObj == ArrayList.class) {
                        ...
                        try {
                            ...
                            throw new RestApiException("N�o suporta conversão do json da classe " + classOfObj.getSimpleName() + ". Json: " + jsonString);
                        }
                ...
                throw new RestApiException("Sint�xe do JSON inválida.");
            } catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | SecurityException e) {
                throw new RestApiException("N�o suporta inst�nciar objeto para a classe " + classOfObj.getSimpleName());
            }
        } else {
            throw new RestApiException("Par�metro classOfObj do m�todo fromJson não deve ser null.");
        }
    }

    /**
     * Retorna uma lista a partir de um json
     *
     * @param jsonString String json
     * @param <T>        String json
     * @param classOfObj	Classe do objeto que serão serializado
    ...
    /**
     * Retorna uma lista a partir de um json. Se o json estiver vazio, retorna apenas uma lista vazia.
     *
     * @param jsonString       String json
     * @param classOfObj	      Classe do objeto que serão serializado
     * @param <T>	             Classe do objeto que serão serializado
     * @param jsonModelAdapter adaptador para permitir obter atributos de modelo
     * @return list
     * @author Everton de Vargas Agilar
     */
            ...
            if (jsonString != null && !jsonString.isEmpty()) {
                ...
                for (Object value : values) {
                    try {
                        ...
                        throw new RestApiException("N�o suporta conversão do json para " + classOfObj.getSimpleName() + ". Json: " + jsonString);
                    }
                }
            }
            return newList;
        } else {
            throw new RestApiException("Par�metro classOfObj do m�todo fromListJson não deve ser null.");
        }
    }
            ...
            for (String field : values.keySet()) {
                try {
                    ...
                    if (field_len == 1) {
                        ...
                        throw new RestApiException("Campo de pesquisa " + field + " inv�lido");
                    }
                    ...
                    if (paramType == Integer.class) {
                        ...
                        if (value_field instanceof String) {
                            ...
                            try {
                                if (len_value >= 6 && len_value <= 10) {
                                    query.setParameter(parameterIndex++, dateFormatDDMMYYYY.parse((String) value_field));
                                } else if (len_value == 16) {
                                    query.setParameter(parameterIndex++, dateFormatDDMMYYYY_HHmm.parse((String) value_field));
                                } else if (len_value == 19) {
                                    query.setParameter(parameterIndex++, dateFormatDDMMYYYY_HHmmss.parse((String) value_field));
                                } else {
                                    throw new RestApiException(m_erro);
                                }
                            } catch (ParseException e) {
    ...
    /**
     * Retorna o id de um objeto. O id � um campo que tenha a anotação @Id
     *
     * @param obj	objeto
    ...
    public static Integer getIdFromObject(final Object obj) {
        if (obj != null) {
            ...
            throw new RestApiException("Par�metro Obj do m�todo getIdFromObject não deve ser null.");
        }
    }
    ...
    public static Enum<?> intToEnum(int value, @SuppressWarnings("rawtypes") final Class<Enum> clazz) {
        if (clazz != null) {
            ...
            throw new RestApiException("Valor inv�lido para o campo " + clazz.getSimpleName());
        } else {
            throw new RestApiException("Par�metro clazz do m�todo intToEnum não deve ser null.");
        }
    }
    ...
    public static Enum<?> StrToEnum(final String value, @SuppressWarnings("rawtypes") final Class<Enum> clazz) {
        if (value != null && !value.isEmpty() && clazz != null) {
            ...
            throw new RestApiException("Par�metros clazz e value do m�todo StrToEnum não devem ser null.");
        }
    }
    ...
    public static String fieldOperatorToSqlOperator(final String fieldOperator) {
        ...
        throw new RestApiException("Operador de atributo " + fieldOperator + " inv�lido.");
    }
    ...
    public static String listFunctionToSqlFunction(final List<String> listFunction) {
        if (listFunction != null) {
            if (listFunction.isEmpty() || (listFunction.size() != 2)) {
                throw new RestApiException("Fun��o SQL precisa de um operador e de uma coluna para listFunctionToSqlFunction.");
            }
            ...
            throw new RestApiException("Fun��o SQL " + function + " inv�lido para listFunctionToSqlFunction.");
        } else {
            throw new RestApiException("Par�metro listFunction não pode ser null para listFunctionToSqlFunction.");
        }
    }
    ...
    public static UniqueConstraint[] getTableUniqueConstraints(final Class<?> classOfModel) {
        if (classOfModel != null) {
            ...
            throw new RestApiException("Par�metro classOfModel não pode ser null para getTableUniqueConstraints.");
        }
    }

    /**
     * Obter a lista de fields com unique constraint de um model.
     * Obs.: Id não � retornado embora tenha a constraint unique.
     *
     * @param classOfModel classe do modelo
    ...
    public static List<Field> getFieldsWithUniqueConstraint(final Class<?> classOfModel) {
        if (classOfModel != null) {
            ...
            throw new RestApiException("Par�metro classOfModel não pode ser null para getFieldsWithUniqueConstraint.");
        }
    }
    ...
    public static List<Field> getFieldsFromModel(final Class<?> classOfModel) {
        if (classOfModel != null) {
            ...
            throw new RestApiException("Par�metro classOfModel não pode ser null para getFieldsFromModel.");
        }
    }
     ...
     *
     * Para que seja possível a conversão � necessário passar a lista dos campos (fields).
     *
     ...
     * @author Everton de Vargas Agilar,
     * @author Rogério Guimaraes Sampaio
     */
    public static List<Map<String, Object>> ListObjectToListMap(final Object fields, final List<?> listObj) {
        if (fields != null && listObj != null) {
            ...
            if (fields instanceof String) {
                ...
                throw new RestApiException("Par�metro fields não � do tipo correto para ListObjectToListMap.");
            }
            ...
            throw new RestApiException("Par�metros fields e ListObj não podem ser null para ListObjectToListMap.");
        }
    }
    ...
    /**
     * Classe respons�vel por representar um filtro ap�s o parser.
     *
     * @author Everton de Vargas Agilar
     */
    ...
    public static EmsFilterStatement parseSqlNativeFilter(final String filter) {
        if (filter != null && filter.length() > 5) {
            try {
                ...
                filtro_obj = (Map<String, Object>) fromJson(filter, HashMap.class);
                ...
                throw new RestApiException("Filtro da pesquisa inv�lido. Motivo: " + e.getMessage());
            }
        } else {
            return null;
        }
    ...
    /**
     * Faz o unquote da string removendo os \" do início e fim
     *
     * @param str string
     * @return str string unquoted
     * @author Everton de Vargas Agilar
     */
