...
import br.erlangms.rest.filter.RestFilterASTCompiler;
            ...
            if (!fields.isEmpty()) {
                ...
                for (String fieldName : fieldList) {
                    ...
                    if (field.isPresent()) {
                        ...
                        throw new RestApiConstraintException(String.format(RestApiConstraintException.ATRIBUTO_IN_OPERADOR_FIELDS_NAO_EXISTE, fieldName));
                    }
                }
            }
        }
            ...
            if (!sort.isEmpty()) {
                ...
                for (String fieldName : sortList) {
                    ...
                    if (fieldOptional.isPresent()) {
                        ...
                        throw new RestApiConstraintException(String.format(RestApiConstraintException.ATRIBUTO_IN_OPERADOR_SORT_NAO_EXISTE, fieldName));
                    }
                }
            }
        }
