...
public class EmsAgent
{
	...
	public void start() throws Exception {
           ...
           while(true) 
	    	   try {
                    ...
                    ret = chamaMetodo(request.getModulo(), request.getFunction(), request);
	...
	private Object chamaMetodo(final String modulo, final String metodo, final EmsRequest request)  {  
	    try {  
	    	Class<?> Classe = Class.forName(modulo);
	    	Method m = Classe.getDeclaredMethod(metodo, EmsRequest.class);   
